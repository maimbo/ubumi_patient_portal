                ...
                <ul class="navbar-nav ms-auto mb-2 mb-md-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="#">Lab results available for Blood Test</a></li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="https://ui-avatars.com/api/?name=Bwalya+Chisanga&background=random" class="rounded-circle me-2" alt="Steven Chiluba" width="30" height="30">
                            <span>Bwalya Chisanga</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                            <li><a class="dropdown-item" href="profile.html"><i class="bi bi-person me-2"></i> Profile</a></li>
                            <li><a class="dropdown-item active" href="settings.html"><i class="bi bi-gear me-2"></i> Settings</a></li>
                            <li><hr class="dropdown-divider"></li>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column mb-2">
                        <li class="nav-item"><a class="nav-link" href="profile.html"><i class="bi bi-person-circle me-2"></i>Profile</a></li>
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="settings.html"><i class="bi bi-gear me-2"></i>Settings</a></li>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="row">
                    <div class="col-lg-8">
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="username" value="bwalya.chisanga" readonly>
                                    </div>
                                    <div class="mb-3">
                                        <label for="emailSettings" class="form-label">Email Address</label>
                                        <input type="email" class="form-control" id="emailSettings" value="bwalya.chisanga@mail.com">
                                        <div class="form-text">Used for login and notifications.</div>
                                    </div>
                                    <button type="button" class="btn btn-primary"><i class="bi bi-envelope-check me-1"></i> Update Email</button>
                                    <hr class="my-4">
                                    ...
                                    <button type="button" class="btn btn-primary"><i class="bi bi-key me-1"></i> Change Password</button>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="form-check form-switch mb-2">
                                        ...
                                        <div class="form-text">Receive updates about appointments, messages, and results via email.</div>
                                    </div>
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input" type="checkbox" role="switch" id="smsNotifications" checked>
                                        <label class="form-check-label" for="smsNotifications">SMS Notifications</label>
                                        <div class="form-text">Receive critical alerts and appointment reminders via SMS.</div>
                                    </div>
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input" type="checkbox" role="switch" id="pushNotifications">
                                        <label class="form-check-label" for="pushNotifications">Push Notifications (Mobile App)</label>
                                        <div class="form-text">Get real-time updates on your mobile device.</div>
                                    </div>
                                    <hr class="my-3">
                                    <h6>Notification Preferences:</h6>
                                    <div class="form-check mb-1">
                                        <input class="form-check-input" type="checkbox" value="" id="appointmentReminders" checked>
                                        <label class="form-check-label" for="appointmentReminders">
                                            Appointment Reminders
                                        </label>
                                    </div>
                                    <div class="form-check mb-1">
                                        <input class="form-check-input" type="checkbox" value="" id="newMessageAlerts" checked>
                                        <label class="form-check-label" for="newMessageAlerts">
                                            New Message Alerts
                                        </label>
                                    </div>
                                    <div class="form-check mb-1">
                                        <input class="form-check-input" type="checkbox" value="" id="labResultNotifications" checked>
                                        <label class="form-check-label" for="labResultNotifications">
                                            Lab Result Notifications
                                        </label>
                                    </div>
                                    <div class="form-check mb-1">
                                        <input class="form-check-input" type="checkbox" value="" id="billingUpdates">
                                        <label class="form-check-label" for="billingUpdates">
                                            Billing Updates & Invoices
                                        </label>
                                    </div>
                                    <div class="mt-3">
                                        <button type="button" class="btn btn-primary"><i class="bi bi-save me-1"></i> Save Notification Settings</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="card shadow-sm mb-4">
                            <div class="card-header">
                                <h5 class="mb-0">Privacy & Data Sharing</h5>
                            </div>
                            <div class="card-body">
                                <p>Manage how your health information is shared with healthcare providers and third-party applications.</p>
                                <button class="btn btn-outline-primary me-2" type="button"><i class="bi bi-link-45deg me-1"></i> Manage Connected Apps</button>
                                <button class="btn btn-outline-secondary" type="button"><i class="bi bi-download me-1"></i> Download My Data</button>
                                <hr class="my-4">
                                <h5>Account Deactivation</h5>
                                <p class="text-muted">Deactivating your account will restrict access to your patient portal. This action can be reversed.</p>
                                <button class="btn btn-outline-danger" type="button"><i class="bi bi-person-x me-1"></i> Deactivate Account</button>
                            </div>
                        </div>
